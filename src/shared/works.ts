...
const works: IWork[] = [
  {
    ...
    website: '',
    repository: `${info.socials.github}/laravelfindeasyjob`,
    technologies: [
    ...
    images: [Work1Desktop, Work1Mobile],
  },
  {
    title: 'Wiwo Site',
    description: 'This is a simple static website.',
    website: '',
    repository: `${info.socials.github}//wiwosite`,
    technologies: [
      skills.programminglanguage.skills[0].name,
    ...
    images: [Work2Desktop, Work2Mobile],
  },
  {
    title: 'Buyback Backend Application Site',
    description:
      'This is a backend application of Ecommerce site.',
    website: '',
    repository: `${info.socials.github}/laravel-ecommerce`,
    technologies: [
      skills.programminglanguage.skills[0].name,
      skills.programminglanguage.skills[1].name,
      skills.programminglanguage.skills[3].name,
    ...
    images: [Work3Desktop, Work3Mobile],
  },
  {
    title: 'Invoice Listing',
    description:
      'This is simple invoice crud app.',
    website: '',
    repository: `${info.socials.github}/laravelinvoicecrud`,
    technologies: [
      skills.programminglanguage.skills[0].name,
      skills.programminglanguage.skills[1].name,
      skills.programminglanguage.skills[3].name,
    ...
    images: [Work4Desktop, Work4Mobile],
  },
]
